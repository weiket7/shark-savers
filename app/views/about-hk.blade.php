...
What do over 270 of Hong Kong's most iconic and influential personalities have in common? They have all taken a personal pledge to stop eating shark fin soup by saying <span class='red bold'>"I'm FINished with Fins"</span>.
</p> 
<br>
...
<p style='line-height:1.7'>"I'm FINished with FINS" campaign is the largest worldwide campaign ever organized for shark conservation. Over 100 of Hong Kong's taste makers and opinion leaders have taken the pledge, joining over 650 celebrities from Singapore, Malaysia, Taiwan, Hong Kong, Shanghai, Beijing, Macau and Maldives, where the campaign has also been launched and widely supported. The Hong Kong campaign is now the largest of the series, and it is perhaps also the largest campaign ever organized for one animal concern.
...
<div style='font-size:24px'><b>Why Hong Kong?</b></div>
<p style='line-height:1.7'>Shark Savers, WildAid, and National Geographic Channel / NatGeo WILD are thrilled to band together to jointly launch the "I'm FINished with Fins" campaign here, because Hong Kong is one of the largest per capita consumers of shark fin soup in the world, and the number one trading hub for the global shark fin trade. Our mission is to empower Hong Kongers, to educate and inform their circles of influence about the plight of sharks; that the unsustainable consumption of shark fin soup is responsible for the intense overfishing of sharks worldwide, destroying a critical link in the maintenance of healthy commercial fisheries and global marine ecosystems.
 
We hope that you will take the pledge, be a campaign ambassador, and help us get 100,000 Hong Kongers to also publicly declare "I'm FINished with Fins". The world is watching us, Hong Kong!</p>
<br>
